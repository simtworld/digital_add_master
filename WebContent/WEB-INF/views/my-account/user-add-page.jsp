...
<div class="row">
	<div class="col-md-2">
		<img src="assets/img/vertical.png" class="rounded mx-auto d-block"
			alt="ad1" height="600" width="120">
	</div>
	<div class="col-md-8">
		<div class="row" style="background-color: deeppink">
			<div class="col-md-3" style="background-color: aqua"></div>
			<div class="col-md-6" style="background-color: #0D6165">
				<img src="h-small.png" class="rounded mx-auto d-block" alt="ad1"
				...
				<div class="col-md-12">
					<div class="card">
						...
						<div class="form-horizontal" id="viewDiv" >
							...
							<div style="overflow-y:scroll; height:600px; background:#f2f2f2">

							<div class="adds" style="padding-left: 10px; padding-right: 10px">
	...
	<div class="col-md-2">
		<img align="right" src="assets/img/vertical.png"
			class="rounded mx-auto d-block" alt="ad2" height="600" width="120">
	</div>
</div>
<div class="row">
	<div class="col-md-2"></div>
	<div class="col-md-8" style="background-color: #4C2E88">
		<img src="horizontal.png" class="rounded mx-auto d-block" alt="ad3"
			height="90" width="728">
	</div>
	<div class="col-md-2"></div>
</div>
