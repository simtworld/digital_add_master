	...
	<div class="container-fluid">
		...
		<!-- 2nd ROW `left Add Block`,`main task pannel`,`right Add Block` START-->
			...
			<!-- 2nd COLUMN of 2nd ROW Start-->
				...
				<!-- Top Add pannel start -->
					<div class="row" style="background-color: deeppink; height: 90px;">
						<div class="col-md-3" style="background-color: aqua"></div>
						<div class="col-md-6"
							style="background-color: #0D6165; height: 90px">
			...
			<!-- 3rd COLUMN of 2nd ROW START -->
				<div class="col-md-2">
					<img align="right" src="assets/img/vertical.png"class="rounded mx-auto d-block" alt="ad2" height="600" width="120">
				</div>
			<!-- 3rd COLUMN of 2nd ROW START -->
		...
		<!-- 3rd ROW `bottom Add Block` START-->
			<div class="row" style="height: 90px">
				...
				<div class="col-md-8"style="background-color: #4C2E88; height: 90px">
